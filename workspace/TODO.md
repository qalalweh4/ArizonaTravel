...
<todo id="visa-assistance-country-pages">
Add real country-specific visa pages for each visa type
Create detailed pages for Schengen, US, UK, Canada, Turkey, Russia, and China routes currently linked from Visa Assistance.
</todo>
<todo id="faq-search-filter">
Add search and category filters to FAQs
Introduce client-side FAQ filtering for quicker answers on long question sets.
</todo>
<todo id="extract-shared-layout">
Extract a reusable site layout wrapper
Move Header, MobileNavigation, FloatingContactButtons, Footer, RouteAnnouncer, and ConsentModal into a shared layout component to remove duplication across pages.
</todo>
<todo id="language-consistency-audit">
Run a full English consistency audit across remaining pages
Verify every route and reusable section has English-only copy, including hidden modal states and footer microcopy.
</todo>
<todo id="navigation-active-state">
Add active-link highlighting in desktop and mobile nav
Use route-aware link states so users can clearly identify the current page from the navigation.
</todo>
