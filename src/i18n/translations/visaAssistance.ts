export const visaAssistance = {
  en: {
    ...
    visaTypes: {
      heading: "Choose Visa Type",
      applyNow: "Apply Now",
      items: {
        chinese: { title: "Chinese Visa" },
        schengen: { title: "Schengen Visa" },
        turkish: { title: "Turkish Visa" },
        russian: { title: "Russian Visa" },
        canadian: { title: "Canadian Visa" },
        american: { title: "American Visa" },
        british: { title: "British Visa" },
      },
    },
    sections: {
      simplified: {
      ...
      international: {
        ...
        paragraph3:
          "This support helps travelers prepare travel visa applications in an organized manner and in compliance with official requirements.",
        points: {
          point1: "Schengen countries in Europe",
          point2: "United Kingdom",
          point3: "United States of America",
          point4: "Canada",
          point5: "Australia and New Zealand",
          point6: "Turkey",
          point7: "Various destinations in Asia",
          point8: "Middle Eastern and GCC countries",
          point9: "Other international destinations",
        },
      },
      byType: {
        ...
        points: {
          point1: "Tourism and Visit Visas",
          point2: "Business and Commercial Travel Visas",
          point3: "Family and Friends Visit Visas",
          point4: "Short-Stay Visas",
          point5: "Transit Visas",
          point6: "Event, Conference, and Special Purpose Visas",
        },
      },
      support: {
        ...
        points: {
          point1: "Initial consultation and eligibility assessment",
          point2:
            "Preparation of required documents list by destination",
          point3: "Application filling guidance and error review",
          point4: "Passport and official document verification",
          point5:
            "Flight and hotel bookings for visa application purposes",
          point6: "Appointment scheduling with embassies or visa centers",
          point7: "Application submission guidance",
          point8: "Application status follow-up",
        },
      },
      schengen: {
        ...
        paragraph3:
          "Our expertise in Schengen visa assistance from Saudi Arabia helps travelers avoid common mistakes and improve the chances of application approval.",
        points: {
          point1: "Selecting the appropriate embassy for submission",
          point2: "Preparation of required financial documents",
          point3:
            "Ensuring travel insurance compliance with visa requirements",
          point4: "Preparation of itinerary and accommodation bookings",
          point5: "Organizing submission steps",
        },
      },
      integrated: {
        ...
        points: {
          ...
          point3: "Holiday packages and honeymoon packages",
          point4: "Cruise trips and multi-country travel programs",
        },
      },
      trust: {
        ...
        points: {
          point1: "Experienced visa service consultants",
          point2:
            "Up-to-date knowledge of embassy and consulate requirements",
          point3: "Accurate document review and compliance verification",
          point4: "Clear procedures for visa application support",
          point5: "Personalized international visa assistance",
        },
      },
    },
    cta: {
  ...
  ar: {
    ...
    visaTypes: {
      heading: "اختر نوع التأشيرة",
      applyNow: "تقديم الطلب الآن",
      items: {
        chinese: { title: "التأشيرة الصينية" },
        schengen: { title: "تأشيرة شنغن" },
        turkish: { title: "التأشيرة التركية" },
        russian: { title: "التأشيرة الروسية" },
        canadian: { title: "التأشيرة الكندية" },
        american: { title: "التأشيرة الأمريكية" },
        british: { title: "التأشيرة البريطانية" },
      },
    },
    sections: {
      simplified: {
      ...
      international: {
        ...
        paragraph3:
          "يساعد هذا الدعم المسافرين على تحضير طلبات تأشيرات السفر بشكل منظم ووفقًا للمتطلبات الرسمية.",
        points: {
          point1: "دول منطقة شنغن في أوروبا",
          point2: "المملكة المتحدة",
          point3: "الولايات المتحدة الأمريكية",
          point4: "كندا",
          point5: "أستراليا ونيوزيلندا",
          point6: "تركيا",
          point7: "وجهات متنوعة في آسيا",
          point8: "دول الشرق الأوسط ومجلس التعاون الخليجي",
          point9: "وجهات دولية أخرى",
        },
      },
      byType: {
        ...
        points: {
          point1: "تأشيرات السياحة والزيارة",
          point2: "تأشيرات سفر الأعمال والتجارة",
          point3: "تأشيرات زيارة العائلة والأصدقاء",
          point4: "تأشيرات الإقامة القصيرة",
          point5: "تأشيرات العبور",
          point6: "تأشيرات الفعاليات والمؤتمرات والأغراض الخاصة",
        },
      },
      support: {
        ...
        points: {
          point1: "استشارة أولية وتقييم الأهلية",
          point2: "تحضير قائمة المستندات المطلوبة حسب الوجهة",
          point3: "إرشاد في تعبئة الطلب ومراجعة الأخطاء",
          point4: "التحقق من جواز السفر والمستندات الرسمية",
          point5: "حجوزات الطيران والفنادق لأغراض طلب التأشيرة",
          point6: "تحديد المواعيد مع السفارات أو مراكز التأشيرات",
          point7: "إرشاد في تقديم الطلب",
          point8: "متابعة حالة الطلب",
        },
      },
      schengen: {
        ...
        paragraph3:
          "تساعد خبرتنا في المساعدة بتأشيرة شنغن من المملكة العربية السعودية المسافرين على تجنب الأخطاء الشائعة وتحسين فرص قبول الطلب.",
        points: {
          point1: "اختيار السفارة المناسبة للتقديم",
          point2: "تحضير المستندات المالية المطلوبة",
          point3: "ضمان توافق التأمين على السفر مع متطلبات التأشيرة",
          point4: "تحضير برنامج الرحلة وحجوزات الإقامة",
          point5: "تنظيم خطوات التقديم",
        },
      },
      integrated: {
        ...
        points: {
          ...
          point3: "باقات العطلات وباقات شهر العسل",
          point4: "رحلات بحرية وبرامج سفر متعددة الدول",
        },
      },
      trust: {
        ...
        points: {
          point1: "مستشارون متخصصون في خدمات التأشيرات",
          point2: "معرفة محدثة بمتطلبات السفارات والقنصليات",
          point3: "مراجعة دقيقة للمستندات والتحقق من التوافق",
          point4: "إجراءات واضحة لدعم طلبات التأشيرات",
          point5: "مساعدة دولية مخصصة في التأشيرات",
        },
      },
    },
    cta: {
