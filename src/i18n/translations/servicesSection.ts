export const servicesSection = {
  en: {
    ...
    card5: {
      title: "Visa Issuance",
      subtitle: "Stress-free visas, handled by experts.",
      description:
        "Our visa specialists handle all documentation and submissions for tourist, business, and transit visas to destinations across the globe - fast and reliably.",
    },
    card6: {
      title: "Car Rental",
    ...
    card7: {
      ...
      subtitle: "Sail the world in style.",
      description:
        "Explore curated cruise itineraries across the Mediterranean, Caribbean, and beyond - combining luxury ocean travel with unforgettable port experiences.",
    },
  },
  ar: {
    heading: "خدماتنا",
    linkText: "اعرف أكثر",
    previousService: "الخدمة السابقة",
    ...
    card5: {
      ...
      subtitle: "تأشيرات بلا عناء، يتولاها خبراء.",
      description:
        "يتولى متخصصو التأشيرات لدينا جميع الإجراءات والمستندات للتأشيرات السياحية والتجارية والعابرة لوجهات حول العالم - بسرعة وموثوقية.",
    },
    card6: {
    ...
    card7: {
      ...
      subtitle: "استمتع بجولة حول العالم بأسلوب راقٍ.",
      description:
        "اكتشف مسارات رحلات بحرية مميزة عبر البحر المتوسط والكاريبي وغيرها - تجمع بين السفر البحري الفاخر وتجارب موانئ لا تُنسى.",
    },
  },
};
