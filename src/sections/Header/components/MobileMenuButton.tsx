export const MobileMenuButton = () => {
  return (
    ...
    >
      <span className="bg-slate-50 box-border caret-transparent block h-0.5 min-h-[auto] min-w-[auto] outline-[3px] no-underline w-[22px] rounded-sm md:bg-white md:min-h-0 md:min-w-0 hover:bg-white"></span>
      <span className="bg-slate-50 box-border caret-transparent block h-0.5 min-h-[auto] min-w-[auto] outline-[3px] no-underline w-[22px] rounded-sm md:bg-white md:min-h-0 md:min-w-0 hover:bg-white"></span>
      <span className="bg-slate-50 box-border caret-transparent block h-0.5 min-h-[auto] min-w-[auto] outline-[3px] no-underline w-[22px] rounded-sm md:bg-white md:min-h-0 md:min-w-0 hover:bg-white"></span>
    </button>
  );
