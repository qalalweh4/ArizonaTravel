  ...
  return (
    <section className="bg-slate-950 box-border caret-transparent leading-[25.6px] outline-[3px] no-underline overflow-hidden py-12 font-cairo md:py-20">
      <div className="box-border caret-transparent max-w-[1440px] outline-[3px] no-underline mx-auto px-4 md:px-12">
        <h2 className="box-border caret-transparent text-slate-50 font-extrabold tracking-tight text-2xl leading-8 outline-[3px] text-center no-underline mb-10 py-0 md:text-3xl md:leading-9 md:pt-[18px] md:pb-2.5">
