...
export const DestinationGallery = () => {
  ...
  return (
    <div className="box-border caret-transparent gap-x-2 grid auto-rows-[120px] grid-cols-[repeat(2,1fr)] grid-rows-none outline-[3px] gap-y-2 no-underline w-full mb-2 md:auto-rows-auto md:grid-cols-[repeat(5,1fr)] md:grid-rows-[repeat(3,130px)]">
      <a
      ...
      >
        <img
          ...
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/246.png"
      ...
      >
        <img
          ...
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/138.png"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          alt="Travel Scene"
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/253.jpg"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          ...
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/279.png"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          ...
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/215.png"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          alt="Annetnavi Scene"
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/71.jpg"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          ...
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/133.jpg"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          alt="Mikel Scene"
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/163.png"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          alt="Sesinando Scene"
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/113.png"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
      <a
      ...
      >
        <img
          ...
          sizes="(max-width: 768px) 50vw, 220px"
          src="https://c.animaapp.com/mq9zlaoimPKAP5/assets/191.png"
          className="box-border text-transparent text-[19.2px] h-full leading-[30.72px] max-w-full object-cover outline-[3px] absolute no-underline w-full inset-0 md:text-base md:leading-[25.6px]"
        />
      </a>
    </div>
