...
export const TailorMadePackagesSection = () => {
  ...
  return (
    <section className="bg-slate-950 box-border caret-transparent leading-[25.6px] outline-[3px] no-underline overflow-hidden py-12 font-cairo md:py-20">
      <div className="box-border caret-transparent max-w-[1440px] outline-[3px] no-underline mx-auto px-4 md:px-12">
        <div className="items-center box-border caret-transparent gap-x-10 flex flex-col outline-[3px] gap-y-10 no-underline md:gap-x-20 md:flex-row md:gap-y-20">
          ...
          <div className="box-border caret-transparent flex flex-col shrink justify-center min-h-[auto] min-w-[auto] outline-[3px] no-underline w-full md:shrink-0 md:w-6/12">
            <h2 className="box-border caret-transparent text-slate-50 font-extrabold tracking-tight text-4xl leading-[45px] min-h-[auto] min-w-[auto] outline-[3px] text-center no-underline mb-6 py-0 md:text-5xl md:leading-[60px] md:pt-[18px] md:pb-2.5">
            ...
            <p className="box-border caret-transparent text-slate-300 leading-[26px] max-w-lg min-h-[auto] min-w-[auto] outline-[3px] no-underline mb-8">
              {t("tailorMadePackagesSection.description")}
            </p>
            <a
              href="https://wa.me/966541272537"
              className="bg-sunset-500 box-border caret-transparent text-white font-semibold block text-sm leading-5 max-w-[135px] min-h-[auto] min-w-[auto] outline-[3px] no-underline px-7 py-3 rounded-lg shadow-soft hover:bg-sunset-600 transition-colors"
            >
