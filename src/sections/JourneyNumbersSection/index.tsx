      ...
      <div className="box-border caret-transparent max-w-[1440px] outline-[3px] no-underline mx-auto px-4 md:px-12">
        <div className="[align-items:normal] box-border caret-transparent gap-x-12 flex flex-col outline-[3px] gap-y-12 no-underline md:items-center md:gap-x-20 md:flex-row md:gap-y-20">
          <div className="box-border caret-transparent flex flex-col shrink min-h-[auto] min-w-[auto] outline-[3px] no-underline w-full md:shrink-0 md:w-[45%]">
            <p className="box-border caret-transparent text-zinc-900 text-4xl font-bold leading-[45px] min-h-[auto] min-w-[auto] outline-[3px] no-underline mb-4 md:text-5xl md:leading-[60px]">
            ...
            <p className="box-border caret-transparent text-stone-500 leading-[26px] max-w-md min-h-[auto] min-w-[auto] outline-[3px] no-underline mb-8">
              {t("journeyNumbersSection.description")}
            </p>
            <a
              href="https://wa.me/966112398888"
              className="bg-orange-400 box-border caret-transparent text-white block text-sm font-semibold leading-5 min-h-[auto] min-w-[auto] outline-[3px] no-underline w-fit px-6 py-3 rounded-lg"
            >
