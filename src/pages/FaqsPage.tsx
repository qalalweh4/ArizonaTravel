          ...
          <div className="space-y-4">
            {faqItemKeys.map((itemKey, index) => {
              ...
              return (
                <article
                  key={itemKey}
                  className="border border-stone-200 rounded-2xl bg-stone-50 overflow-hidden"
                >
                  <button
                    type="button"
                  ...
                  >
                    <span className="text-zinc-900 text-base font-bold md:text-lg">
                      {t(`${itemKey}.q`)}
                    </span>
                  ...
                  {isOpen ? (
                    <div className="px-5 pb-5 md:px-6 md:pb-6">
                      <p className="text-stone-700 text-sm leading-8 md:text-base">
                        {t(`${itemKey}.a`)}
                      </p>
                    </div>
                  ) : null}
          ...
          <div className="bg-white border border-stone-200 rounded-2xl p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 gap-4 mt-6 md:grid-cols-2">
              <a
                ...
                className="rounded-xl bg-stone-100 px-5 py-4 text-zinc-900 font-semibold"
              >
                +966112398888
              </a>
              <a
